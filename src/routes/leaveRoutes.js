...
router.post('/resend-otp', protect, authenticateStudent, resendOTP);
...
// Principal route for student leave history
router.get('/student/:studentId/history', principalAuth, getStudentLeaveHistory);
