...
const validateReminderConfig = [
  ...
  body('postReminders.email.frequencyType').optional().isIn(['daily', 'alternate', 'custom']).withMessage('Post email frequency type must be daily, alternate, or custom'),
  body('postReminders.email.maxDaysAfterDue').optional().isInt({ min: 1, max: 365 }).withMessage('Post email max days after due must be between 1 and 365'),
  body('postReminders.email.daysAfterDue').optional().isArray().withMessage('Post email days after due must be an array'),
  body('postReminders.email.daysAfterDue.*').optional().isInt({ min: 1, max: 365 }).withMessage('Days after due must be between 1 and 365'),
  ...
  body('postReminders.push.frequencyType').optional().isIn(['daily', 'alternate', 'custom']).withMessage('Post push frequency type must be daily, alternate, or custom'),
  body('postReminders.push.maxDaysAfterDue').optional().isInt({ min: 1, max: 365 }).withMessage('Post push max days after due must be between 1 and 365'),
  body('postReminders.push.daysAfterDue').optional().isArray().withMessage('Post push days after due must be an array'),
  body('postReminders.push.daysAfterDue.*').optional().isInt({ min: 1, max: 365 }).withMessage('Days after due must be between 1 and 365'),
  ...
  body('postReminders.sms.frequencyType').optional().isIn(['daily', 'alternate', 'custom']).withMessage('Post SMS frequency type must be daily, alternate, or custom'),
  body('postReminders.sms.maxDaysAfterDue').optional().isInt({ min: 1, max: 365 }).withMessage('Post SMS max days after due must be between 1 and 365'),
  body('postReminders.sms.daysAfterDue').optional().isArray().withMessage('Post SMS days after due must be an array'),
  body('postReminders.sms.daysAfterDue.*').optional().isInt({ min: 1, max: 365 }).withMessage('Days after due must be between 1 and 365'),
